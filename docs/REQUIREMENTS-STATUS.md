...
- 店员端讨论材料见 [04-staff-miniapp.md](04-staff-miniapp.md)；当前优先讨论工作台与全部菜单，具体提案状态和本端待决索引由该文件维护。
...
| `03f-customer-messages.md` | 原消息规则、投诉短信为新增渠道、主人食品风险另行形成店员待办 | 短信接收人与发送配置；待办归属、权限和生命周期 | `DEC-STAFF-03`、`DEC-STAFF-07`（04索引） |
...
| DEC-FOOD-RESP-01 | 已确认客服邮件联系厂家；厂家回信入系统、正式回应判定、多主体责任及期限映射待决 | 03h §11 |
