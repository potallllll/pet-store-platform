...
客户端投诉入口统一为“我的 → 投诉与建议”；首页“消费争议”承担公开信息浏览。“建议”处理流程仍待确认，不能默认公开。门店正式回应属于店员端，不在客户端增加门店回应按钮；本店所有有效在职员工及老板均可提交正式回应，其他动作边界见04。
...
宠物档案承载基本资料、护理档案、寄养资料、当前食用宠物食品、服务记录、服务相册和宠物行为与服务安全档案；具体规则及跨店共享阻塞见03b、03h。

顾客端共享模块使用“跨店服务信息共享”，宠物护理注意事项与服务履约记录分别勾选、默认均不勾选。后者为顾客客观风险事件的对外名称，需明确展示经核验的预约未到、费用结算争议、服务安全事件等例子及处理结果；完整文案见03h§10.3。护理分项可保留“共享宠物护理注意事项给未来的门店”，不能用于替代服务履约记录的说明。具体入口位置、撤回及接收范围仍待确认。
...
| C-RISK-01 | 首页消费争议入口与未核验展示边界 | [03h-customer-risk-feedback.md](03h-customer-risk-feedback.md) |
...
| C-HOME-01 | 首页 | 门店、当前服务、消费争议、上门喂养、商品 | 主要入口 |
...
| C-RISK-01 | 消费争议 / 风险反馈 | 附近门店、宠物食品、未核验状态 | 进入列表 / 详情 |
...
- 寄养动态时间轴能力
- 消费争议 / 风险反馈入口、投诉状态及食品问题热度语义；具体布局受DEC-RISK-UI-01阻塞，热度算法受DEC-FOOD-HEAT-01阻塞
- 上门喂养入口、状态与隐私边界
- “我的”资产卡信息组成
- 平台积分独立入口
- N 组对比能力
