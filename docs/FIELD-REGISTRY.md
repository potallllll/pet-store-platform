...
> `04-staff-miniapp.md` 已确认范围为§3.0导航与洗美/寄养归属，以及§6.1投诉回应基线、§6.5跨端职责。具体菜单、员工权限与跨店共享细节仍待确认；本注册表不授予业务权限。
...
- `03a`～`03m`、`03o`～`03p`
- `04-staff-miniapp.md` 当前已确认§3.0、§6.1、§6.5与来自01/02/03的已确认跨端约束
